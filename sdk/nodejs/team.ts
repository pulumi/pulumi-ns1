...
export interface TeamState {
     ...
     * List of records that the team may access.
     */
    dnsRecordsAllows?: pulumi.Input<pulumi.Input<inputs.TeamDnsRecordsAllow>[] | undefined>;
    /**
     * List of records that the team may not access.
     */
    dnsRecordsDenies?: pulumi.Input<pulumi.Input<inputs.TeamDnsRecordsDeny>[] | undefined>;
    /**
     * Whether the team can view the accounts zones.
     */
     ...
     * Array of IP addresses objects to chich to grant the team access. Each object includes a **name** (string), and **values** (array of strings) associated to each "allow" list.
     */
    ipWhitelists?: pulumi.Input<pulumi.Input<inputs.TeamIpWhitelist>[] | undefined>;
    /**
     * Whether the team can create monitoring jobs when manageJobs is not set to true.
     */
