...
export interface ZoneState {
    additionalNetworks?: pulumi.Input<pulumi.Input<number>[] | undefined>;
    additionalNotifyOnlies?: pulumi.Input<pulumi.Input<boolean>[] | undefined>;
     ...
     * being created.
     */
    autogenerateNsRecord?: pulumi.Input<boolean | undefined>;
    /**
     * (Computed) Authoritative Name Servers.
     */
     ...
     * (Computed) The SOA Hostmaster.
     */
    hostmaster?: pulumi.Input<string | undefined>;
    /**
     * The target zone(domain name) to link to.
     */
     ...
     * `additionalPrimaries` (default must be accepted).
     */
    nxTtl?: pulumi.Input<number | undefined>;
    /**
     * The primary zones' IPv4 address. This makes the zone a
     * secondary. Conflicts with `secondaries`.
     */
     ...
     * Secondaries is documented below.
     */
    secondaries?: pulumi.Input<pulumi.Input<inputs.ZoneSecondary>[] | undefined>;
    /**
     * map of tags in the form of `"key" = "value"` where both key and value are strings
     */
     ...
     * TSIG is documented below
     */
    tsig?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
    /**
     * The SOA TTL.
     */
