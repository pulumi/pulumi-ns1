...
public final class UserDnsRecordsDenyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public UserDnsRecordsDenyArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("UserDnsRecordsDenyArgs", "domain");
            }
            if ($.includeSubdomains == null) {
                throw new MissingRequiredPropertyException("UserDnsRecordsDenyArgs", "includeSubdomains");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("UserDnsRecordsDenyArgs", "type");
            }
            if ($.zone == null) {
                throw new MissingRequiredPropertyException("UserDnsRecordsDenyArgs", "zone");
            }
            return $;
        }
    }
