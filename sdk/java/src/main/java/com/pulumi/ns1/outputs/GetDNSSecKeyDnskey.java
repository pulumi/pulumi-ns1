...
public final class GetDNSSecKeyDnskey {
    ...
    public static final class Builder {
        ...
        public Builder algorithm(String algorithm) {
            if (algorithm == null) {
              throw new MissingRequiredPropertyException("GetDNSSecKeyDnskey", "algorithm");
            }
        ...
        public Builder flags(String flags) {
            if (flags == null) {
              throw new MissingRequiredPropertyException("GetDNSSecKeyDnskey", "flags");
            }
            this.flags = flags;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetDNSSecKeyDnskey", "protocol");
            }
        ...
        public Builder publicKey(String publicKey) {
            if (publicKey == null) {
              throw new MissingRequiredPropertyException("GetDNSSecKeyDnskey", "publicKey");
            }
