...
public final class MonitoringJobState extends com.pulumi.resources.ResourceArgs {

    public static final MonitoringJobState Empty = new MonitoringJobState();
    ...
    public static Builder builder(MonitoringJobState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitoringJobState();
        }

        public Builder(MonitoringJobState defaults) {
            $ = new MonitoringJobState(Objects.requireNonNull(defaults));
        }
        ...
        public MonitoringJobState build() {
            return $;
        }
    }
