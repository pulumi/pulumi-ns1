...
public final class APIKeyDnsRecordsDenyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public APIKeyDnsRecordsDenyArgs build() {
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("APIKeyDnsRecordsDenyArgs", "domain");
            }
            if ($.includeSubdomains == null) {
                throw new MissingRequiredPropertyException("APIKeyDnsRecordsDenyArgs", "includeSubdomains");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("APIKeyDnsRecordsDenyArgs", "type");
            }
            if ($.zone == null) {
                throw new MissingRequiredPropertyException("APIKeyDnsRecordsDenyArgs", "zone");
            }
            return $;
        }
    }
