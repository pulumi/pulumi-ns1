...
public final class TeamDnsRecordsAllow {
    ...
    public static final class Builder {
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("TeamDnsRecordsAllow", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder includeSubdomains(Boolean includeSubdomains) {
            if (includeSubdomains == null) {
              throw new MissingRequiredPropertyException("TeamDnsRecordsAllow", "includeSubdomains");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("TeamDnsRecordsAllow", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder zone(String zone) {
            if (zone == null) {
              throw new MissingRequiredPropertyException("TeamDnsRecordsAllow", "zone");
            }
            this.zone = zone;
            return this;
        }
