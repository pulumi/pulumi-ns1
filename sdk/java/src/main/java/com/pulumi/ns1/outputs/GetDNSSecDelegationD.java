...
@CustomType
public final class GetDNSSecDelegationD {
    /**
    ...
    public static Builder builder(GetDNSSecDelegationD defaults) {
    ...
    public static final class Builder {
        ...
        private String publicKey;
        public Builder() {}
        public Builder(GetDNSSecDelegationD defaults) {
        ...
        public GetDNSSecDelegationD build() {
            final var _resultValue = new GetDNSSecDelegationD();
